function Myc_fcprocess_HCP_dtseriesRetest(switches, Subjlist, source_dir, work_dir, tseries)
...
%    sub_dir = fullfile(source_dir, sub);
    ...
    try
        ...
        for t = 1:NR % runs 
            ...
            sub_dir=fullfile(source_dir,strcat(sub,'_3T/RESOURCES/',teries{t},'_PostFix'));
