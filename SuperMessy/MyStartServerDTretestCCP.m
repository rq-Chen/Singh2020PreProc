function[]=MyStartServerDTretestCCP(Subjects,nGSR,copyBase,Atlas)
...
out_base=strcat('/scratch2/Singh/HCP/Retest/Out/');
out_dir=strcat('/scratch2/Singh/HCP/Retest/GSR',num2str(nGSR),'/Out');
...
in_dir='/scratch2/Singh/HCP/Retest/Data/';
%clear
...
d112817ParcellateServerRetest(str2double(Subjlist),nGSR,[],Atlas);
end
