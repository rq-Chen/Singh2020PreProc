function[]=RepeatMyStartServerDT(Subjects,nGSR,copyBase)
...
out_base=strcat('/scratch2/Singh/HCP/Repeat/Out/');
out_dir=strcat('/scratch2/Singh/HCP/Repeat/GSR',num2str(nGSR),'/Out');
