...
% originally writen and used by Joshua Siegel
%in the following paper:
%https://academic.oup.com/cercor/article/27/9/4492/3056417
%
%This code was later edited by Carolina Ramirez and Mitchell Jeffers
%(mjeffers@wustl.edu)
%to generalize the uses for processing both DMCC or HCP Subjects
%Added Features:
%Output file structure builder
%DVar Calculator
%
...
out_dir='/scratch2/Singh/HCP/Out/';
...
% c_fcprocess_HCP_dtseries(switches, Subjlist, in_dir, out_dir, tseries)
