...
clear
in_dir = '/data/hcp-zfs/OpenAccess/900subject/'
%in_dir  = '/data/nil-bluearc/ccp-hcp/DMCC_ALL_BACKUPS/HCP_SUBJECTS_BACKUPS/MINIMALLY_PREPROCESSED/' % the Directoy where your subject data lives
out_dir = '/scratch1/MitchJeffers/restingState/out/HCP'% Where the results will be output
Subjlist = {'132017'}%list of subjects to be ran through the pipeline
