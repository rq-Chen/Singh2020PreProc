...
% All Rights Reserved
function getHCPregressorsCompCor_final_DMCC(Subject, in_dir, out_dir,tseries)
%% Only change is I removed the hp2000 part
 ...
 %      subplot(2,2,4);imagesc(CSF2(:,:,48));title('eroded image');
    ...
    for t=1:length(tseries)
        ...
        if ~exist(outputname,'file')
            ...
            rfMRIname = fullfile(in_dir, sub, '/MNINonLinear/Results', tseries{t}, [tseries{t}]);
