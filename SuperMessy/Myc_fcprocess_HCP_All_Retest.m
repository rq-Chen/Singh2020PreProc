function Myc_fcprocess_HCP_All_Retest(GSR,Subjlist,RestC,TaskCell,TaskAll,Atlas)
...
bDir='/scratch2/Singh/HCP_All_Retest/GSR';
...
%disp(ParcName)
    X.Dat=FullDat(iY,:);
save(strcat(bDir,num2str(GSR),'/sub',sub,ParcName,'_All_Retest','.mat'),'X');
end
    else
        ParcName=Atlas(1);
        X.Dat=FullDat;
