function[]=MyStartServerDT_HCP_All_Retest(Subjects,nGSR,copyBase,TaskAll,Atlas)
...
OutDir=strcat('/scratch2/Singh/HCP_All_Retest/GSR',num2str(nGSR),'/Out/');
disp('Doing Rest')
...
RestOut=MyStartServerDT_HCP_All_Retest_restpart(Subjects(RestExist==0),nGSR,copyBase); 
...
TaskOut=MyStartServerDT_HCP_All_Retest_taskpart(Subjects(TaskExist==0),nGSR,copyBase,TaskAll{iTask}); 
...
Myc_fcprocess_HCP_All_Retest(nGSR,Subjects,RestOut,FullTaskOut,TaskAll,Atlas); 
