function[Out]=MyStartServerDT_HCP_All_restpart(Subjects,nGSR,copyBase)

%% Uses a different folder for regressors b/c this time I'm not using ICA-FIX
...
out_base=strcat('/scratch2/Singh/HCP_All/Out/');
out_dir=strcat('/scratch2/Singh/HCP_All/GSR',num2str(nGSR),'/Out');
...
Out={switches,in_dir, out_dir, tseries};
end
